...
var messageBroker = builder.AddContainer("messagebroker", "rabbitmq", "3-management")
...
builder.AddProject<Projects.Basket_API>("basket-api")
    ...
    .WithEnvironment("InternalServiceAuth__ServiceName", "Basket.API")
    .WithEnvironment("InternalServiceAuth__Scopes__0", "discount.read")
    .WithEnvironment("InternalServiceAuth__TokenLifetimeMinutes", "5")
    ...
    .WithEnvironment("MessageBroker__UseSsl", "false")
    .WithEnvironment("Jwt__Issuer", "EShop.Identity")
    .WithEnvironment("Jwt__Audience", "EShop.Services")
    .WithEnvironment("Jwt__Secret", jwtSecret)
    .WithEnvironment("Seq__ServerUrl", seq.GetEndpoint("http"))
